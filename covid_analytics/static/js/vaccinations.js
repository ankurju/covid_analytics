document.addEventListener('DOMContentLoaded', function () {
    ...
    yearDropdownCombined.addEventListener('change',function(){
        ...
        updateGraph('combinedGraph', plot_data_vaccinations_combined[selectedYear]);
    });

    // Get the card text elements
    var totalVaccinationText = document.getElementById('totalVaccinationText');
    ...
    function updateCardData(selectedCountry, selectedYear) {
        ...
        updateGraph('countryGraph', selectedCountryData.plot_data_vaccinations[selectedYear]);

        // to update card text content
        totalVaccinationText.textContent = selectedCountryData.total_vaccinations;
