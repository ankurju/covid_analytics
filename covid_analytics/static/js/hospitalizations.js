document.addEventListener('DOMContentLoaded', function () {
    ...
    yearDropdownCombined.addEventListener('change',function(){
        ...
        updateGraph('combinedGraph', plot_data_hospitalizations_combined[selectedYear]);
    });

    // Get the card text elements
    var totalHospitalizationText = document.getElementById('totalHospitalizationText');
    ...
    function updateCardData(selectedCountry, selectedYear) {
        ...
        updateGraph('countryGraph', selectedCountryData.plot_data_hospitalizations[selectedYear]);

        // to update card text content
        totalHospitalizationText.textContent = selectedCountryData.total_hospitalizations;
